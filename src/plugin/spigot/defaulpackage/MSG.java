...
public enum MSG {
	...
	PLAYER_JOIN(new String[] {"[p] ha acceduto", "[p] è entrato", "Ecco [p] u trmon", "Un caldo benvenuto a [p] u trmon"}),
	...
	WAKE_UP(new String[] {"[p] bastardo si è alzato", "[p] si è svegliato di soprassalto"}),
	GOOD_MORNING(new String[] {"Buongiorno trimone", "Buongiorno cazzone", "Buongiornissimo, caffè?", "Buongiorno, ben svegliato", "Buongiorno un cazzo"}),
